...
export declare class AdminService {
    ...
    getAllUsers(pagination: PaginationDto, filters?: any): Promise<{
        data: {
            business_profiles: {
                company_name: string;
    ...
    getAllCampaigns(pagination: PaginationDto, filters?: any): Promise<{
        data: ({
            business_profiles: {
                users: {
                    email: string;
    ...
    getAllTransactions(pagination: PaginationDto, filters?: any): Promise<{
        data: ({
            users: {
                email: string;
                user_type: import(".prisma/client").$Enums.user_type | null;
    ...
    approveTransaction(transactionId: number): Promise<{
        message: string;
        transaction: {
            description: string | null;
            id: number;
    ...
    rejectTransaction(transactionId: number, reason?: string): Promise<{
        message: string;
        transaction: {
            description: string | null;
            id: number;
    ...
    suspendUser(userId: number, reason?: string): Promise<{
        message: string;
        user: {
            email: string;
            user_type: import(".prisma/client").$Enums.user_type | null;
